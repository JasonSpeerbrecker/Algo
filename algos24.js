...
console.log(findTripletsBruteForce(nums1))
console.log(findTripletsBruteForce(nums2))
console.log(findTripletsBruteForce(nums3))

console.log(findTriplets2(nums1))
console.log(findTriplets2(nums2))
console.log(findTriplets2(nums3))
